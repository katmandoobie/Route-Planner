...
```
git clone https://github.com/katmandoobie/Route-Planner.git --recurse-submodules
```
or with SSH:
```
git clone git@github.com:katmandoobie/Route-Planner.git --recurse-submodules
```
